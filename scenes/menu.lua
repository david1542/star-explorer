...
local function gotoHighScores()
    composer.gotoScene(SCENES.HIGH_SCORES, TRANSITIONS.PAGE_CHANGE)
end
...
function scene:create( event )
	...
	local title = display.newImageRect( sceneGroup, IMAGES.GAME_TITLE, 500, 80 )
	...
	musicTrack = audio.loadStream(MUSIC.MENU)
end
